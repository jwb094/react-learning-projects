        ...
        <div class="card-body  p-0 my-3 text-start">
            <div className="row">
                ...
                <div className="col-2 | p-0 my-auto">
                    <button className={like === true ? 'btn btn-light border border-dark' : 'btn btn-dark'}
                        onClick={() => setlike((like) => like === true ? false : true)}>
                        {like === true ? <i className="bi bi-hand-thumbs-up"></i> : <i className="bi bi-hand-thumbs-up-fill"></i>}
                    </button>
                </div>
            </div>
